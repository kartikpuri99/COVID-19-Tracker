...
const CovidNewsScreen = () => {
  ...
  return (
    <React.Fragment>
      <section id="covidnews" className="home">
        <div className="home__box">
          ...
          <div className="home__bottom">
            <a className="btn-down" href="#covidnews-card">
              See The Latest News on COVID-19{" "}
      ...
      {errors ? (
        <div className="alert alert-danger" style={{ paddingBottom: "4rem" }}>
          {errors}
        </div>
      ) : news.length <= 0 ? (
        <div
        ...
        <section id="covidnews-card">
          <div className="container">
            <div className="cards__heading-box text-center mb-4 pb-4 ">
              <h1 className="cards__heading">Current COVID-19 News</h1>
              <hr className="mb-5 "></hr>
            </div>
            <div className="row">
              {news.slice(0, 12).map((newss) => (
                <div className="col-md-4 mb-5" key={newss.title}>
                  <CovidNewsCard newss={newss} />
                </div>
              ))}
...
export default CovidNewsScreen;
