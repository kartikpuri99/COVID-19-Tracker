...
function CovidTracker() {
  return (
    <React.Fragment>
      ...
      <section>
        {/* <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1400.5 176.04"><path d="M1399.5,299.5q.26-59.74.5-119.5c-212.34,74.32-367.9,64.72-471,42C833.49,201,797.69,171.86,658,147c-91.62-16.31-199.75-35.43-333-14A835.78,835.78,0,0,0-.5,259.5v40Z" transform="translate(0.5 -123.46)"/></svg>    
         <svg
          id="Layer_1"
          data-name="Layer 1"
        ...
        >
          <path fillOpacity="1" d="M0,192L1440,128L1440,320L0,320Z"></path>
        </svg> */}
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1943.5 315.5" className='Layer_1'>
